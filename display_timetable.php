...
<body>
    <div class="container">
        ...
        // Retrieve schedule data with subject names and class names for the specified section
        $section = $_GET['section'] ?? 'CSE-A'; // Default to CSE-A if section is not provided
